...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-settings-channel-link/SYS-SCL-P10.md", "confidence": 0.95}]
...
depends_on: ["SYS-SCL-P09"]
domain: "quality"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-settings-channel-link"
file_path: "tasks/feat-settings-channel-link/SYS-SCL-P10.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-SCL-P10"
...
- feature_package_id: feature-package/feat-settings-channel-link
- parent_feature: feat-settings-channel-link
- owners: daishiman / tags: p10, quality, settings-channel-link / related_nodes: feat-settings-channel-link
- workstream_kind: quality
- build_target_kind: application-code
- depends_on: SYS-SCL-P09
- classification: confidence 0.95 / P10 phase slot への 1対1 写像 / tasks/feat-settings-channel-link/SYS-SCL-P10.md
...
差分全体を scope_in と対応付け、scope_out(他 feature の処理本体・複数チャンネル・新色トークン)に触れていないことを確かめる。
...
- Quality: 主。差分全体を scope_in と対応付け、scope_out(他 feature の処理本体・複数チャンネル・新色トークン)に触れていないことを確かめる。
...
- docs/feat-settings-channel-link/final-review.md
- Consumed artifacts: features/feat-settings-channel-link.context.json, 先行 task の成果物
- Write scope: docs/feat-settings-channel-link/final-review.md
...
- 次の task: SYS-SCL-P11, SYS-SCL-P12
