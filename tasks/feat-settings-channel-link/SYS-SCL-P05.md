...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-settings-channel-link/SYS-SCL-P05.md", "confidence": 0.95}]
...
file_path: "tasks/feat-settings-channel-link/SYS-SCL-P05.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-SCL-P05"
...
start_date: null
status: "active"
tags: ["p05", "frontend", "settings-channel-link"]
target_date: null
template_id: "task"
template_version: "1.0.0"
title: "共通レイアウト・設定画面・チャンネル紐付け API の実装"
