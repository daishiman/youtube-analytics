...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-settings-channel-link/SYS-SCL-P07.md", "confidence": 0.95}]
...
depends_on: ["SYS-SCL-P06"]
domain: "quality"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-settings-channel-link"
file_path: "tasks/feat-settings-channel-link/SYS-SCL-P07.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-SCL-P07"
...
- feature_package_id: feature-package/feat-settings-channel-link
- parent_feature: feat-settings-channel-link
- owners: daishiman / tags: p07, quality, settings-channel-link / related_nodes: feat-settings-channel-link
- workstream_kind: quality
- build_target_kind: application-code
- depends_on: SYS-SCL-P06
- classification: confidence 0.95 / P07 phase slot への 1対1 写像 / tasks/feat-settings-channel-link/SYS-SCL-P07.md
...
preview 環境で受入10項目を手動確認と自動テストの両方で確かめ、画像との差分(配色を除く)を記録する。
...
- Quality: 主。preview 環境で受入10項目を手動確認と自動テストの両方で確かめ、画像との差分(配色を除く)を記録する。
...
- docs/feat-settings-channel-link/acceptance.md
- Consumed artifacts: features/feat-settings-channel-link.context.json, 先行 task の成果物
- Write scope: docs/feat-settings-channel-link/acceptance.md
