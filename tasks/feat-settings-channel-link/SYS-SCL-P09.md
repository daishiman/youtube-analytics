...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-settings-channel-link/SYS-SCL-P09.md", "confidence": 0.95}]
...
depends_on: ["SYS-SCL-P08"]
domain: "security"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-settings-channel-link"
file_path: "tasks/feat-settings-channel-link/SYS-SCL-P09.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-SCL-P09"
...
- feature_package_id: feature-package/feat-settings-channel-link
- parent_feature: feat-settings-channel-link
- owners: daishiman / tags: p09, security, settings-channel-link / related_nodes: feat-settings-channel-link
- workstream_kind: security
- build_target_kind: application-code
- depends_on: SYS-SCL-P08
- classification: confidence 0.95 / P09 phase slot への 1対1 写像 / tasks/feat-settings-channel-link/SYS-SCL-P09.md
...
OAuth スコープ・revoke・oauth_pending 暗号化・CF_ANALYTICS_TOKEN の Secrets 管理・Origin 検査・レート制限・audit_log を点検し、lint/型/依存脆弱性を確認する。
...
- Security: 主。OAuth スコープ・revoke・oauth_pending 暗号化・CF_ANALYTICS_TOKEN の Secrets 管理・Origin 検査・レート制限・audit_log を点検し、lint/型/依存脆弱性を確認する。
- Quality: 副。セキュリティと品質の保証のうち Quality に関わる部分
...
- docs/feat-settings-channel-link/qa-report.md
- Consumed artifacts: features/feat-settings-channel-link.context.json, 先行 task の成果物
- Write scope: docs/feat-settings-channel-link/qa-report.md
...
- 受入: high 以上の脆弱性0件
- 受入: refresh token・トークン平文・CF_ANALYTICS_TOKEN がリポジトリとログに現れない
