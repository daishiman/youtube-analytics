...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-settings-channel-link/SYS-SCL-P01.md", "confidence": 0.95}]
...
file_path: "tasks/feat-settings-channel-link/SYS-SCL-P01.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-SCL-P01"
...
- feature_package_id: feature-package/feat-settings-channel-link
- parent_feature: feat-settings-channel-link
- owners: daishiman / tags: p01, documentation, settings-channel-link / related_nodes: feat-settings-channel-link
- workstream_kind: documentation
- build_target_kind: application-code
- depends_on: なし
- classification: confidence 0.95 / P01 phase slot への 1対1 写像 / tasks/feat-settings-channel-link/SYS-SCL-P01.md
...
- 先行 task: なし(feature 間依存 feat-platform-tenant-auth ほか4件は dev-graph が管理)
...
- docs/feat-settings-channel-link/requirements.md(受入10項目×根拠章×区画/API×検証方法の対応表)
- Consumed artifacts: features/feat-settings-channel-link.context.json, system-spec 確定章
- Write scope: docs/feat-settings-channel-link/requirements.md
...
- 検証: 対応表の行数が受入項目数10と一致することを目視とスクリプトで確認
- 受入: 受入10項目すべてに根拠章・区画/API・検証方法が1対1で対応している
- 受入: 新規エラーコードの一覧と画像からの文言差し替えが確定している
