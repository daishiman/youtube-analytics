...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-dashboard-redesign/sys-dbr-p11.md", "confidence": 0.95}]
classification_confidence: 0.95
classification_reason: "P11 phase slot への1対1写像"
...
file_path: "tasks/feat-dashboard-redesign/sys-dbr-p11.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-DBR-P11"
...
- evidence/feat-dashboard-redesign/index.json と参照ファイル
- Write scope: evidence/feat-dashboard-redesign/
...
- 検証: index.jsonの全参照先ファイルが実在することを確認
- 受入: 受入13項目すべてに証跡がある(acc-01〜acc-13)

## Rollout and rollback

- Rollout: 機能ブランチを PR で main へ merge
- Rollback: index.jsonを直前版へ戻す
