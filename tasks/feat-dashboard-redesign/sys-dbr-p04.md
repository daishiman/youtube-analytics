...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-dashboard-redesign/sys-dbr-p04.md", "confidence": 0.95}]
classification_confidence: 0.95
classification_reason: "P04 phase slot への1対1写像"
...
file_path: "tasks/feat-dashboard-redesign/sys-dbr-p04.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-DBR-P04"
...
resource_scope: ["tests/dashboard/", "e2e/dashboard.spec.ts", "docs/feat-dashboard-redesign/test-design.md"]
scope_in: []
scope_out: []
source_lineage: {"origin_kind": "system-dev-planner", "source_plugin": "system-dev-planner", "source_path": ".dev-graph/published/feature-package-feat-dashboard-redesign-r2/task-specs/phase-04-test-design.md", "source_version": "0.1.0", "source_digest": "8753a49bb769c2bee8d85a0f15d801e6f97b49ed86837558895cbe090f08ab1d", "imported_at": "2026-09-24T15:08:34Z"}
start_date: null
status: "active"
tags: ["p04", "quality", "dashboard-redesign"]
target_date: null
template_id: "task"
template_version: "1.0.0"
title: "受入テストとPlaywright E2Eの設計"
...
受入項目ごとの単体・API テスト(vitest)と、Playwright 3サイズ(390×844・820×1180・1440×900)の E2E を先に書く。AppShell 共通ヘッダーの PERIODS に 7d が追加され 7d/28d/90d/1y/custom(省略時28d)になっていること、期間リンクが既存クエリ(scope/video_ids)を保持して period だけ差し替えること、任意期間366日以上・from>toで400になること、対象セレクタの合計と重ね線、動画別実績の構成比切替、video_ids 101本以上での200応答、テナント境界の黙示的除外、空状態5種、360px 横スクロールなしを含める。
...
- e2e/dashboard.spec.ts(390×844・820×1180・1440×900の3サイズ)
...
- 受入: AppShell PERIODSの7d追加・期間リンクの既存クエリ保持・任意期間366日以上とfrom>toの400が実装前に失敗するテストとして存在する(acc-02)
