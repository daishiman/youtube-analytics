...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-dashboard-redesign/sys-dbr-p05.md", "confidence": 0.95}]
classification_confidence: 0.95
classification_reason: "P05 phase slot への1対1写像"
...
file_path: "tasks/feat-dashboard-redesign/sys-dbr-p05.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-DBR-P05"
...
start_date: null
status: "active"
tags: ["p05", "frontend", "dashboard-redesign"]
target_date: null
template_id: "task"
template_version: "1.0.0"
title: "ダッシュボードUI・集約API・ファネルAPI・サムネイル配信・Cronの実装"
