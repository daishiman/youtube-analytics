...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-dashboard-redesign/sys-dbr-p12.md", "confidence": 0.95}]
classification_confidence: 0.95
classification_reason: "P12 phase slot への1対1写像"
...
file_path: "tasks/feat-dashboard-redesign/sys-dbr-p12.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-DBR-P12"
...
resource_scope: ["docs/feat-dashboard-redesign/runbook.md", "README.md"]
scope_in: []
scope_out: []
source_lineage: {"origin_kind": "system-dev-planner", "source_plugin": "system-dev-planner", "source_path": ".dev-graph/published/feature-package-feat-dashboard-redesign-r2/task-specs/phase-12-documentation-operations.md", "source_version": "0.1.0", "source_digest": "8753a49bb769c2bee8d85a0f15d801e6f97b49ed86837558895cbe090f08ab1d", "imported_at": "2026-09-24T15:08:34Z"}
start_date: null
status: "active"
tags: ["p12", "operations", "dashboard-redesign"]
target_date: null
template_id: "task"
...
thumbnail 通と Cron 役割①(30日超削除)の運用手順、1,100本超テナントの1,000本上限の運用上の扱い、scripts/seed-local.sql を使ったローカル確認手順、migrations/0008_dashboard_media_assets.sql の本番適用手順を runbook にまとめる。P13(本番D1マイグレーションとdeploy)は利用者の明示指示がない限り実行されない可能性がある旨を runbook に明記する。
