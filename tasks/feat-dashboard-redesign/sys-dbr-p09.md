...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-dashboard-redesign/sys-dbr-p09.md", "confidence": 0.95}]
classification_confidence: 0.95
classification_reason: "P09 phase slot への1対1写像"
...
depends_on: ["SYS-DBR-P08"]
domain: "security"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-dashboard-redesign"
file_path: "tasks/feat-dashboard-redesign/sys-dbr-p09.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-DBR-P09"
...
resource_scope: ["docs/feat-dashboard-redesign/qa-report.md"]
scope_in: []
scope_out: []
source_lineage: {"origin_kind": "system-dev-planner", "source_plugin": "system-dev-planner", "source_path": ".dev-graph/published/feature-package-feat-dashboard-redesign-r2/task-specs/phase-09-quality-assurance.md", "source_version": "0.1.0", "source_digest": "8753a49bb769c2bee8d85a0f15d801e6f97b49ed86837558895cbe090f08ab1d", "imported_at": "2026-09-24T15:08:34Z"}
start_date: null
status: "active"
tags: ["p09", "security", "dashboard-redesign"]
target_date: null
template_id: "task"
template_version: "1.0.0"
title: "セキュリティ・アクセシビリティ・運用保証"
tracker_binding: "beads"
updated_at: "2026-09-24T15:08:34Z"
---

# SYS-DBR-P09 セキュリティ・アクセシビリティ・運用保証
...
CSP と各ヘッダの実応答、Cache-Control: private, no-store、テナント境界、period パラメータの400判定(qa-109)、thumbnail 通の subrequest 件数、コントラストとタップ領域を確認する。
...
- docs/feat-dashboard-redesign/qa-report.md
- Write scope: docs/feat-dashboard-redesign/qa-report.md
...
- 検証: curl -Iでヘッダを確認
- 検証: curl で不正なperiod・任意期間366日以上・from>toを送り400を確認
- 受入: high以上の脆弱性0件
- 受入: GET /api/dashboardの応答にCache-Control: private, no-storeが付き、CSPのimg-srcが'self' data:のまま変わらないことを確認する(acc-09)
- 受入: thumbnail通1通のsubrequestが50件以内に収まることを確認する(acc-12)
- 受入: 360px幅と44ptタップ領域を満たすことを確認する(acc-10)
- 受入: 許可外のperiod・任意期間366日以上・from>toが400になることを確認する(acc-02)

## Rollout and rollback

- Rollout: 機能ブランチを PR で main へ merge
- Rollback: qa-report.mdの是正事項をP05へ差し戻す
