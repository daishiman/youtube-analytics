...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-dashboard-redesign/sys-dbr-p01.md", "confidence": 0.95}]
classification_confidence: 0.95
classification_reason: "P01 phase slot への1対1写像"
...
file_path: "tasks/feat-dashboard-redesign/sys-dbr-p01.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-DBR-P01"
...
resource_scope: ["docs/feat-dashboard-redesign/requirements.md"]
scope_in: []
scope_out: []
source_lineage: {"origin_kind": "system-dev-planner", "source_plugin": "system-dev-planner", "source_path": ".dev-graph/published/feature-package-feat-dashboard-redesign-r2/task-specs/phase-01-requirements.md", "source_version": "0.1.0", "source_digest": "8753a49bb769c2bee8d85a0f15d801e6f97b49ed86837558895cbe090f08ab1d", "imported_at": "2026-09-24T15:08:34Z"}
start_date: null
status: "active"
tags: ["p01", "documentation", "dashboard-redesign"]
target_date: null
template_id: "task"
template_version: "1.0.0"
title: "ダッシュボード刷新の要件を実装単位へ確定"
...
feature の受入13項目(acc-01〜acc-13)を qa-099〜qa-109 の根拠章と検証方法・担当 phase へ1対1で対応付け、画面正本 docs/screens/02-dashboard.png の区画順(ヘッダ・対象セレクタ・問い・KPI 4枚・日次推移・動画別の実績と構成比・最新AI分析・実施中の改善アクション・詳しく見る)と既存インディゴ/マゼンタ配色を確定する。期間は全画面共通の AppShell ヘッダーの `?period=` に統一し(qa-109)、ダッシュボード内にページ内の期間タブは置かないことを対応表に明記する。
...
- docs/feat-dashboard-redesign/requirements.md(受入対応表・区画順対応表・qa 番号対応表・?period= 統一の対応関係)
...
- 受入: 画面の区画順・文言・配色が docs/screens/02-dashboard.png と system-spec ui-ux 章の記述どおりに列挙され、期間タブがページ内に存在しないことが明記されている(acc-02)
