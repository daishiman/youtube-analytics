...
差分全体を scope_in / scope_out と突合し、feat-youtube-daily-collection・feat-csv-media-ingest・feat-skill-analysis-reports・feat-web-screens-actions・feat-settings-channel-link の範囲へはみ出していないか、migrations/0016_dashboard_media_assets.sql が読み取り専用境界(書込みAPIを作らない)を守っているかを確認する。
