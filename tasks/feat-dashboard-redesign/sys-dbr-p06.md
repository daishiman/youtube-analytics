...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-dashboard-redesign/sys-dbr-p06.md", "confidence": 0.95}]
classification_confidence: 0.95
classification_reason: "P06 phase slot への1対1写像"
...
file_path: "tasks/feat-dashboard-redesign/sys-dbr-p06.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-DBR-P06"
...
resource_scope: ["tests/dashboard/", "e2e/dashboard.spec.ts", "web/", "src/"]
scope_in: []
scope_out: []
source_lineage: {"origin_kind": "system-dev-planner", "source_plugin": "system-dev-planner", "source_path": ".dev-graph/published/feature-package-feat-dashboard-redesign-r2/task-specs/phase-06-test-run.md", "source_version": "0.1.0", "source_digest": "8753a49bb769c2bee8d85a0f15d801e6f97b49ed86837558895cbe090f08ab1d", "imported_at": "2026-09-24T15:08:34Z"}
start_date: null
status: "active"
tags: ["p06", "quality", "dashboard-redesign"]
target_date: null
template_id: "task"
...
単体・API・E2E を全件実行し、失敗を修正する。scripts/seed-local.sql のテストデータを使ったローカルD1でのdashboard表示確認を含める。
