...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-platform-tenant-auth/SYS-PTA-P03.md", "confidence": 0.95}]
...
depends_on: ["SYS-PTA-P02"]
domain: "security"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-platform-tenant-auth"
file_path: "tasks/feat-platform-tenant-auth/SYS-PTA-P03.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-PTA-P03"
...
resource_scope: ["docs/feat-platform-tenant-auth/design-review.md"]
scope_in: []
scope_out: []
source_lineage: {"imported_at": "2026-09-21T14:53:23Z", "origin_kind": "system-dev-planner", "source_digest": "6e46c44289a97833c3c2c07fe53f3de4232895bd5c8f332291a34706873bafd6", "source_path": ".dev-graph/published/feature-package-feat-platform-tenant-auth/task-specs/phase-03-design-review.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
start_date: null
status: "active"
tags: ["p03", "security", "platform-tenant-auth"]
target_date: null
template_id: "task"
template_version: "1.0.0"
title: "認証・越境防止の設計レビュー"
tracker_binding: "beads"
updated_at: "2026-09-21T14:53:23Z"
---

# SYS-PTA-P03 認証・越境防止の設計レビュー
...
OAuth Authorization Code+PKCE、state 検証、セッション Cookie(256bit・30日・HttpOnly・Secure・SameSite=Lax)、招待トークンのハッシュ保存を OWASP ASVS の観点でレビューする。
...
- docs/feat-platform-tenant-auth/design-review.md(ASVS 章ごとの判定と是正事項)
- Write scope: docs/feat-platform-tenant-auth/design-review.md
