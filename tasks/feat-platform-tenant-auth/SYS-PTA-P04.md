...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-platform-tenant-auth/SYS-PTA-P04.md", "confidence": 0.95}]
...
depends_on: ["SYS-PTA-P03"]
domain: "quality"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-platform-tenant-auth"
file_path: "tasks/feat-platform-tenant-auth/SYS-PTA-P04.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-PTA-P04"
...
resource_scope: ["tests/platform/", "docs/feat-platform-tenant-auth/test-design.md"]
scope_in: []
scope_out: []
source_lineage: {"imported_at": "2026-09-21T14:53:23Z", "origin_kind": "system-dev-planner", "source_digest": "6e46c44289a97833c3c2c07fe53f3de4232895bd5c8f332291a34706873bafd6", "source_path": ".dev-graph/published/feature-package-feat-platform-tenant-auth/task-specs/phase-04-test-design.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
start_date: null
status: "active"
tags: ["p04", "quality", "platform-tenant-auth"]
target_date: null
template_id: "task"
template_version: "1.0.0"
title: "受入テストと越境テストの設計"
tracker_binding: "beads"
updated_at: "2026-09-21T14:53:23Z"
---

# SYS-PTA-P04 受入テストと越境テストの設計
...
受入6項目を自動テストへ写像する。未ログイン401、閲覧者書込403、他テナントID 404、招待メール不一致拒否、上限到達の受付停止、初回ログインで1組作成。
...
- docs/feat-platform-tenant-auth/test-design.md
- tests/platform/ 配下の失敗するテスト(Vitest+Miniflare)
- Write scope: tests/platform/, docs/feat-platform-tenant-auth/test-design.md
...
- 検証: npm test でテストが列挙され、実装前は失敗する
- 受入: 受入6項目それぞれに少なくとも1つのテストケースがある
- 受入: 越境テストは全 tenant スコープ API を網羅する

## Rollout and rollback

- Rollout: 機能ブランチを PR で main へ merge
- Rollback: tests/platform/ の追加分を削除する
