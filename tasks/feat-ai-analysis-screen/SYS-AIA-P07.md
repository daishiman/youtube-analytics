...
artifact_subtypes: []
beads_linkage: null
classification_candidates: [{"artifact_kind": "task", "candidate_path": "tasks/feat-ai-analysis-screen/SYS-AIA-P07.md", "confidence": 0.95}]
...
depends_on: ["SYS-AIA-P06"]
domain: "quality"
evaluation_status: "pass"
execution_contexts: []
feature_package_id: "feature-package/feat-ai-analysis-screen"
file_path: "tasks/feat-ai-analysis-screen/SYS-AIA-P07.md"
github_project_linkages: []
github_publication: {"labels": [], "milestone": null, "mode": "local_only", "project_aliases": []}
goal: null
graph_node_id: "SYS-AIA-P07"
...
resource_scope: ["docs/feat-ai-analysis-screen/acceptance.md"]
scope_in: []
scope_out: []
source_lineage: {"imported_at": "2026-09-24T15:54:55Z", "origin_kind": "system-dev-planner", "source_digest": "0c0bad66583d733a2d8f79c4587656e2ba5a4bc0f03093cb72b4ccdb68b12894", "source_path": ".dev-graph/published/feature-package-feat-ai-analysis-screen/task-specs/phase-07-acceptance.md", "source_plugin": "system-dev-planner", "source_version": "0.1.0"}
start_date: null
status: "active"
tags: ["p07", "quality", "ai-analysis-screen"]
target_date: null
template_id: "task"
...
- feature_package_id: feature-package/feat-ai-analysis-screen
- parent_feature: feat-ai-analysis-screen
- owners: daishiman / tags: p07, quality, ai-analysis-screen / related_nodes: feat-ai-analysis-screen
- workstream_kind: quality
- build_target_kind: application-code
- depends_on: SYS-AIA-P06
- classification: confidence 0.95 / P07 phase slot への 1対1 写像 / tasks/feat-ai-analysis-screen/SYS-AIA-P07.md
...
acceptance 13項目それぞれについて、実装済みの画面・APIで合格したことを記録し、未合格が残っていない状態にする。

## 背景

実装・テストが完了した時点で、goal-spec の acceptance 13項目それぞれが実際に満たされているかを画面とAPIの両方で確認する。
...
- Quality: 主。acceptance 13項目の合格確認
...
- docs/feat-ai-analysis-screen/acceptance.md
- Consumed artifacts: P06 のテスト結果
- Write scope: docs/feat-ai-analysis-screen/acceptance.md
...
- 受入: 受入13項目すべてが合格
- 受入: goal-spec の invisible_requirements_added にあるポーリングの開始・停止条件(待機中・実行中0件で停止、hidden で停止、visible 復帰で再開、10秒間隔)と、幅900px未満の表示切替(2カラム縦積み・表のカード化・下部バー固定)が、preview 環境の手動確認で個別に合格している
