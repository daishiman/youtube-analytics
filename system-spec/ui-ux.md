...
| プラットフォーム | 状態 | 根拠 |
|---|---|---|
| Web (web) | 確定 | 確定質疑: qa-067。裏付け質疑 (`qa_refs`): `qa-054`, `qa-001`, `qa-011`, `qa-012`, `qa-013`, `qa-014`, `qa-016`, `qa-027`, `qa-029`, `qa-030`, `qa-031`, `qa-015`, `qa-032`, `qa-033`, `qa-034`, `qa-037`, `qa-038`, `qa-039`, `qa-040`, `qa-036`, `qa-041`, `qa-043`, `qa-044`, `qa-045`, `qa-046`, `qa-047`, `qa-042`, `qa-048`, `qa-049`, `qa-050`, `qa-051`, `qa-052`, `qa-053`, `qa-055`, `qa-056`, `qa-057`, `qa-058`, `qa-059`, `qa-062`, `qa-063`, `qa-064`, `qa-065`, `qa-066`, `qa-068`, `qa-070`, `qa-071`, `qa-072`, `qa-073`, `qa-075`, `qa-076` — 本章の「確定内容 (質疑録)」へ接地根拠として併記。資するゴール: G2, G4, G5 |
...
|---|---|---|---|---|---|
| presentation | Apple Human Interface Guidelines | 画面設計・操作フロー・情報階層・アクセシビリティの上流原則 | https://developer.apple.com/design/human-interface-guidelines | 2026-07-12 | [qa-016/qa-027/qa-029] 各画面の最上部に問い、次に結論(KPI/主な発見)、要因(数字の事実→推定した心理)、打ち手の順。心理の記述には必ず『推定』バッジと確信度を付け、事実の数字と見た目で区別する。操作は1画面1主ボタン。 設定画面も1画面1主ボタンの原則に合わせ、各区画の主操作を1つ(連携/取込/発行)に絞り、連携解除・データ削除は危険操作として ConfirmDialog の名前入力を経る(qa-067)。無料枠は色だけでなく%の数値と文言でも状態を示す(70%黄/90%赤・qa-072)。 |
...
画面・メール文面・規約で使う「テナント」という語が一般の利用者に伝わりにくい。利用者に見せる語をどうするか。あわせて、qa-075 で必須にした Google Cloud の接続情報を、Google Cloud を触ったことがない人でも用意できるようにするか
