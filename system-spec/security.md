...
| プラットフォーム | 状態 | 根拠 |
|---|---|---|
| Web (web) | 確定 | 確定質疑: qa-067。裏付け質疑 (`qa_refs`): `qa-053`, `qa-030`, `qa-015`, `qa-033`, `qa-035`, `qa-037`, `qa-038`, `qa-039`, `qa-040`, `qa-022`, `qa-041`, `qa-042`, `qa-043`, `qa-044`, `qa-046`, `qa-047`, `qa-045`, `qa-048`, `qa-049`, `qa-050`, `qa-051`, `qa-052`, `qa-054`, `qa-055`, `qa-056`, `qa-057`, `qa-058`, `qa-059`, `qa-062`, `qa-063`, `qa-064`, `qa-065`, `qa-066`, `qa-069`, `qa-071`, `qa-073`, `qa-070`, `qa-072`, `qa-075` — 本章の「確定内容 (質疑録)」へ接地根拠として併記。資するゴール: G4 |
