...
| プラットフォーム | 状態 | 根拠 |
|---|---|---|
| Web (web) | 確定 | 確定質疑: qa-052。裏付け質疑 (`qa_refs`): `qa-014`, `qa-028`, `qa-037`, `qa-038`, `qa-015`, `qa-042`, `qa-043`, `qa-044`, `qa-045`, `qa-046`, `qa-047`, `qa-041`, `qa-048`, `qa-049`, `qa-050`, `qa-051`, `qa-053`, `qa-054`, `qa-055`, `qa-056`, `qa-057`, `qa-058`, `qa-059` — 本章の「確定内容 (質疑録)」へ接地根拠として併記。資するゴール: G3, G4 |
...
|---|---|---|---|---|---|
| operations | Google SRE | 運用手順・障害対応・トイル削減・ポストモーテムの上流指針 | https://sre.google/workbook/ | 2026-07-12 | [qa-028] 運用手順をdocs/runbook.mdに4本置く(OAuth再連携、無料枠超過時の対応、スキル更新、R2容量逼迫時の場面画像整理)。障害はWorkers Logsとlast_collected_atが7日超の利用者数で検知する。 |
