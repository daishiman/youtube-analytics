...
- 規模: Cloudflare Queues の無料枠(1万操作/日・安全予算8,000)と D1 無料枠(書込10万行/日)に収めるため、テナント数の上限を75とする(上限到達時は新規テナントを作らない。qa-100 で100から変更)
...
qa-100: U8 制約の『テナント数の上限100』を Queue 予算に合わせて75へ更新することを利用者が承認(U1-U9 の他項目は appr-011/appr-014 のまま)
