...
| プラットフォーム | 状態 | 根拠 |
|---|---|---|
| Web (web) | 確定 | 確定質疑: qa-054。裏付け質疑 (`qa_refs`): `qa-016`, `qa-024`, `qa-029`, `qa-030`, `qa-031`, `qa-015`, `qa-032`, `qa-033`, `qa-034`, `qa-037`, `qa-038`, `qa-039`, `qa-040`, `qa-036`, `qa-041`, `qa-043`, `qa-044`, `qa-045`, `qa-046`, `qa-047`, `qa-042`, `qa-048`, `qa-049`, `qa-050`, `qa-051`, `qa-052`, `qa-053`, `qa-055`, `qa-056`, `qa-057`, `qa-058`, `qa-059` — 本章の「確定内容 (質疑録)」へ接地根拠として併記。資するゴール: G2, G4, G5 |
...
| application-architecture | Robert C. Martin — Clean Architecture | レイヤ境界・依存方向 (内向き)・ユースケース中心設計 | Clean Architecture (2017), the Dependency Rule | 2026-07-12 | [qa-024/qa-032/qa-033/qa-031] 画面はpages/*(6つ: login・dashboard・videos・ai-analysis・actions・settings)+静的ページ2枚(privacy・terms)と、api client層の2層に分け、画面からfetchを直接呼ばずapi client経由にする。状態はURLクエリ(期間・選択ID)とサーバ応答だけで持ち、グローバルストアを置かない。グラフは4種の部品(折れ線・横棒・行内の横棒・小さな推移線)にまとめて各画面から使う。(層の分け方は qa-037 で承認) |
