...
function locateSkillHome() {
  ...
  throw new Error("yt-analyze の場所が分かりません。YT_ANALYZE_HOME に .claude/skills/yt-analyze の絶対パスを設定してください");
}

const { runAnalysis } = await import(pathToFileURL(join(locateSkillHome(), "lib", "render.mjs")).href);
